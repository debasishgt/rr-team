...
CREATE TABLE `player_vehicles` (
  ...
  PRIMARY KEY (`id`),
  KEY `player_vehicle_upgrade_idx` (`upgrade_id`),
  ...
  CONSTRAINT `player_vehicle_upgrade` FOREIGN KEY (`upgrade_id`) REFERENCES `upgrades` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `powerups` (
  ...
  `health` double NOT NULL DEFAULT '0',
  `acceleration` double NOT NULL DEFAULT '0',
  `is_invincible` tinyint(1) NOT NULL DEFAULT '0',
...
-- Dump completed on 2015-11-17 13:42:07
