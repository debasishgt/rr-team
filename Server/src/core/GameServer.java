...
public class GameServer {
    ...
    public static HashMap<String, Player> activePlayers = new HashMap<String, Player>(); // Stores active players by player ID
    ...
    public GameServer() {
        ...
        GameServer.activePlayers.clear();
    ...
    public void removeActivePlayer(String playerId){
    	GameServer.activePlayers.remove(playerId);
    }
    public void addActivePlayer(String playerId, Player player){
    	GameServer.activePlayers.put(playerId, player);
    }
    public Player getActivePlayer(String playerId){
    	return GameServer.activePlayers.get(playerId);
    }
    public HashMap<String, Player> getActivePlayers(){
    	return GameServer.activePlayers;
    }
    public int getActivePlayerCount(){
    	return GameServer.activePlayers.size();
    }
    public void setActivePlayerPos(String playerId, float x, float y, float z){
    	GameServer.activePlayers.get(playerId).setXYZ(x, y, z);
    }
    /**
	...
	public void addResponseForOneOnlinePlayer(String player_id,
			GameResponse response, String player_id_2) {
		for (GameClient client : activeThreads.values()) {
			if (client.getPlayerId().equalsIgnoreCase(player_id) ) {
				client.addResponseForUpdate(response);
			}
		}
	}
