...
public class Powerup {
	...
	public Powerup(int id, String name) {
		this(id,name,"",0.0,0.0,0.0,0.0,false,false,false,0);
	}
	
	public Powerup(int id, String name, String description, double damage, double armor, double health, double acceleration, boolean canMakeImmune, boolean canBlind, boolean canToggle, int quantity) {
		this.id = id;
		this.name = name;
