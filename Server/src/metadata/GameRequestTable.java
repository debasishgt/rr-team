...
public class GameRequestTable {
    ...
    public static void init() {
        ...
        add(Constants.CMSG_KEY, "RequestKey");
        add(Constants.CMSG_CREATE_CHARACTER, "RequestCreateCharacter");
        add(Constants.CMSG_DISCONNECT, "RequestDisconnect");

		//chat
		add(Constants.CMSG_CHAT_ALL, "RequestChatAll");
		add(Constants.CMSG_CHAT_ONE, "RequestChatOne");
		add(Constants.CMSG_USERS, "RequestUsers");
    }
